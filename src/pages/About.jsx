    ...
    <section className="py-8">
      <div className="container grid items-center gap-8 md:grid-cols-2">
        <div className="space-y-3">
          ...
          <p>Pa Pa is a San Antonio grandmother and lifelong maker who discovered ceramics as a way to relax and connect with her community. Every plate and mug is hand‑painted by her steady hands, then fired with love. She’s a proud senior artist and small business owner who believes that everyday objects should bring joy.</p>
